  ...
  async findCandidates(game: NormalizedGame): Promise<StoredGame[]> {
    ...
    return records.map((record) => {
      ...
      return {
        ...
        totalRating: record.totalRating ?? undefined,
        totalRatingCount: record.totalRatingCount ?? undefined,
    ...
    if (existing) {
      ...
      await this.client.game.update({
        ...
        data: {
          ...
          ratingCount: game.ratingCount ?? existing.ratingCount,
          totalRating: game.totalRating ?? existing.totalRating,
          totalRatingCount: game.totalRatingCount ?? existing.totalRatingCount,
